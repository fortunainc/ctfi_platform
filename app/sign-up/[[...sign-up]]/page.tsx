      ...
      <div className="w-full max-w-md px-4">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 text-lg">
            Access failure patterns, submit retrospective analyses, and get urgent help
          </p>
        </div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm text-blue-800">
              <p className="font-semibold mb-1">Sign-up Options</p>
              <p className="text-blue-700">Use email/password for quickest access. Google sign-up may require opening in a full browser.</p>
            </div>
          </div>
        </div>
